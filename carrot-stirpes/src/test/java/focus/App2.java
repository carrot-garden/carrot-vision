 ...
 * Refer to SysOut.
 */
public class App2 implements Application, Application.UnprocessedKeyHandler {

	private static final int NATIVE_WINDOW_WIDTH = 700;
	private static final int NATIVE_WINDOW_HEIGHT = 600;
	...
	@Override
	public void startup(Display primaryDisplay, Map<String, String> properties)
			throws Exception {

		primaryDisplay.getHostWindow().setSize(NATIVE_WINDOW_WIDTH,
		...
		final Display secondaryDisplay = DesktopApplicationContext
				.createDisplay(NATIVE_WINDOW_WIDTH, NATIVE_WINDOW_HEIGHT, 300,
						300, false, true, false,
						primaryDisplay.getHostWindow(), null);
	...
	public static void main(String[] args) {
		...
		DesktopApplicationContext.main(App2.class, args);
